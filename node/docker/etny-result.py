...
class etnyPoX:
    def __init__(self):
        ...
        etnyPoX.etny = etnyPoX.w3.eth.contract(address=etnyPoX.w3.toChecksumAddress("0x2f5b4cdaf5A03Cb9947F9213821d94B758D1f312"), abi=etnyPoX.contract_abi)
    ...
    def addResult():
        ...
        try:
            ...
            print("Result IPFS: %s" % etnyPoX.result)
